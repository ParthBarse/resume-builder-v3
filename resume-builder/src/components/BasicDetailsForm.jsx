  ...
  return (
    ...
    <Stack>
      <SimpleGrid columns={[1, 1, 1, 2]} spacing={9} placeItems="center">
        <FormControl>
        <FormLabel display="inline">Choose Language to fill up the form <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Box >
            <RadioGroup
        ...
        <FormControl>
         <FormLabel display="inline">Given Name(s) / Vorname <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="text"
        ...
        <FormControl>
         <FormLabel display="inline">Father's Name / Vater Name <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="text"
            placeholder={"Father's Name / Vater Name"}
            onChange={(e) => {
              const updateValue = {
                ...resumeInfo.profile,
        ...
        <FormControl>
         <FormLabel display="inline">Surname/ Nachname <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="text"
      ...
      <FormControl>
       <FormLabel display="inline">Country/Länder <Text  as="span" fontWeight="bold" color="red">  * </Text>: </FormLabel>
        <Select
          type="text"
          placeholder=" country"
      ...
      <FormControl>
       <FormLabel display="inline">Address/ Adresse <Text  as="span" fontWeight="bold" color="red">  * </Text>: </FormLabel>
        <Textarea
          placeholder=""
      ...
      <br />
      <FormControl>
       <FormLabel display="inline">Contact Number/Kontaknummer <Text  as="span" fontWeight="bold" color="red">  * </Text>:</FormLabel>
    ...
    >
            ...
            <option>
              +500 GS: South Georgia and the South Sandwich Islands (UK)
            </option>
      ...
      <FormControl>
       <FormLabel display="inline">Email address / E-Mail-Adresse <Text  as="span" fontWeight="bold" color="red">  * </Text>:</FormLabel>
        <Input
          type="email"
      ...
      >
        <FormControl>
         <FormLabel display="inline">Birthdate/Geburtsdatum <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="date"
            onChange={(e) => {
        ...
        <FormControl>
         <FormLabel display="inline" >Place of Birth / Geburtsort:<Text as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="text"
        ...
        <FormControl>
          <FormLabel display="inline" style={{ marginRight:'-30px' }}>Passport Number / Reisepassnummer:<Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            type="text"
        ...
        <SimpleGrid columns={[1, 1, 1, 1]} spacing={1} placeItems="center">

        <FormControl>
          {/* <FormLabel>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FormLabel> */}
         <FormLabel display="inline" marginBottom={'-50px'}>Upload passport <Text  as="span" fontWeight="bold" color="red">  * </Text> (pdf)</FormLabel>
        </FormControl>
        <FormControl>
          ...
          key={inputKey}
            ...
            onChange={(e) => {
              ...
              const updateProfile = {
                ...resumeInfo.profile,
                passport_file_name: `passport.${ext}`,
              };
            ...
            rightIcon={<AddIcon />}
          />
          <Button color="#00b0ff" marginLeft={2} marginRight={4} marginTop={2} onClick={() => {
  if (selectedFile2) {
    window.open(URL.createObjectURL(selectedFile2));
  } else {
...
<Button color="red" marginTop={2}  onClick={() => {
  ...
  Delete
          ...
          {selectedFile2 && <p>Selected file 2: {selectedFile2.name}</p>}
          </FormControl>
</SimpleGrid>
      </SimpleGrid>
      <br />
      ...
      >
        <FormControl>
         <FormLabel display="inline">Marital Status/ Familienstand <Text  as="span" fontWeight="bold" color="red">  * </Text>:</FormLabel>
          <Select
        ...
        <FormControl>
         <FormLabel display="inline" style={{ marginRight:'-30px' }}>Gender/Geschlecht(wie im reisepass):<Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Select
            placeholder="Select an option"
      ...
      <SimpleGrid columns={[1, 1, 1, 2]} spacing={9} placeItems="center">
        <FormControl>
         <FormLabel display="inline">Hobbies / Hobbies <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            placeholder="Hobby 1"
            value={resumeInfo.profile.hobbi1[0]}
            onChange={(e) => {
          ...
          {blocks.map((value, index) => (
            <Input
              ...
              key={index + 1}
              type="text"
              value={resumeInfo?.profile?.hobbi1?.[index + 1] || ""}
              onChange={(e) => {
                const newHobbies = [...(resumeInfo?.profile?.hobbi1 || [])];
                newHobbies[index + 1] = e.target.value;
        ...
        <FormControl>
          <FormControl>
           <FormLabel display="inline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FormLabel>
            <Button marginRight={4} color="#00b0ff" onClick={addBlock}>
              Add&nbsp;
            </Button>
        ...
        <FormControl>
         <FormLabel display="inline">Computer skills /Computerkenntnisse <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
          <Input
            placeholder="Computer skills 1"
            value={resumeInfo.profile.ComputerSkills1[0]}
            onChange={(e) => {
              const ComputerSkills1 = [
                ...(resumeInfo?.profile?.ComputerSkills1 || []),
              ];
              ComputerSkills1[0] = e.target.value;
          ...
          {blocks2.map((value, index) => (
            <Input
              ...
              key={index + 1}
              type="text"
              value={resumeInfo?.profile?.ComputerSkills1?.[index + 1] || ""}
              onChange={(e) => {
                const newComputerSkills = [
                  ...(resumeInfo?.profile?.ComputerSkills1 || []),
                ];
                ...
                const updatedProfile = {
                  ...resumeInfo?.profile,
                  ComputerSkills1: newComputerSkills,
                };
        ...
        <FormControl>
         <FormLabel display="inline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FormLabel>
          <Button marginRight={4} color="#00b0ff" onClick={addBlock2}>
            Add&nbsp;
          </Button>
          <Button
            color="red"
...
<SimpleGrid columns={[1, 1, 1, 2]} spacing={2} placeItems="center">
         <FormControl>
         <FormLabel display="inline"style={{ marginRight:'-30px' }}>Candidate image/foto kandidaten(jpg) <Text  as="span" fontWeight="bold" color="red">  * </Text></FormLabel>
        </FormControl>
  ...
  Delete
      ...
      <br />
      <p style={paragraphStyle}>
        Image must be a Passport Photo and should be the same everywhere. High
        resolution image required.
      </p>
      ...
      <Center mt={8}>
        <Button
          ...
          onClick={() => {
            ...
            // Mapping of keys to alert messages
            const alertMessages = {
